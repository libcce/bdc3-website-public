...
const ByodPage = () => (
    <PageContent width="95%" maxWidth="1200px" center gutters>
        ...
        <section>
            ...
            <Paragraph center>
                <OutsideLink asButton to="https://sb-biodatacatalyst.readme.io/docs/upload-to-the-platform">BYOD to BioData Catalyst powered by Seven Bridges</OutsideLink>
            </Paragraph>
            
            <br/>

            <Paragraph center>
                <OutsideLink asButton to="https://bdcatalyst.gitbook.io/biodata-catalyst-documentation/analyze-data/terra/using-your-own-data-with-terra">BYOD to BioData Catalyst powered by Terra</OutsideLink>
            </Paragraph>
        </section>
